    ...
    function render_attributes(categories) {
        ...
        $.each(categories, function(name, attrs) {         
            ...
            $.each(attrs, function(index, attr) {
                $($root.find(".attribute")[i]).append("<tr><td class=\"attr\">"+attr+"</td><td class=\"value\"></td><td class=\"maximum\"><td class=\"cost\"></td><td class=\"boost\"></td><td class=\"total\"></td><td><input class=\"minus\" type=\"button\" value=\"-\" /></td><td><input class=\"plus\" type=\"button\" value=\"+\" /></td><td><input class=\"max\" type=\"button\" value=\"Max\" /></td></tr>");
